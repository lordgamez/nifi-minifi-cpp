...
def step_impl(context: MinifiTestContext, proxy_type: str, container_name: str):
    ...
    controller_service.add_property("Proxy Type", "DIRECT" if proxy_type.lower() == "direct" else "HTTP")
...
def setup_controller_service_in_minifi_flow(context: MinifiTestContext, service_name: str, minifi_container_name: str):
    ...
    context.get_or_create_minifi_container(minifi_container_name).flow_definition.controller_services.append(controller_service)
