...
class OpcUaTestServer {
 public:
  explicit OpcUaTestServer(UA_UInt16 port = 4840) : server_(UA_Server_new()) {
    ...
    auto int666_node = addIntVariable("666", opc::OPCNodeIDType::Int, device2_node, 256);
 ...
 private:
  ...
  static void readRawCallback(UA_Server* /*server*/, void* hdbContext, const UA_NodeId* /*sessionId*/, void* /*sessionContext*/,
      const UA_RequestHeader* /*requestHeader*/, const UA_ReadRawModifiedDetails* historyReadDetails, UA_TimestampsToReturn /*timestampsToReturn*/,
      UA_Boolean /*releaseContinuationPoints*/, size_t nodesToReadSize, const UA_HistoryReadValueId* nodesToRead, UA_HistoryReadResponse* response,
    ...
    for (size_t i = 0; i < nodesToReadSize; ++i) {
      ...
      const std::vector<const HistoryModificationRecord*> records =
          selectRecords(it->second, historyReadDetails->startTime, historyReadDetails->endTime, historyReadDetails->numValuesPerNode, has_more_data);
  ...
  static void readModifiedCallback(UA_Server* /*server*/, void* hdbContext, const UA_NodeId* /*sessionId*/, void* /*sessionContext*/,
      const UA_RequestHeader* /*requestHeader*/, const UA_ReadRawModifiedDetails* historyReadDetails, UA_TimestampsToReturn /*timestampsToReturn*/,
      UA_Boolean /*releaseContinuationPoints*/, size_t nodesToReadSize, const UA_HistoryReadValueId* nodesToRead, UA_HistoryReadResponse* response,
