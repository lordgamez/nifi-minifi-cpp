...
struct ConsumeMqttTestFixture {
  ConsumeMqttTestFixture() {
    ...
    consumeMqttProcessor_ = dynamic_cast<TestConsumeMQTTProcessor*>(plan_->addProcessor("TestConsumeMQTTProcessor", "consumeMqttProcessor"));
    REQUIRE(consumeMqttProcessor_ != nullptr);
  }
  ...
  TestConsumeMQTTProcessor* consumeMqttProcessor_ = nullptr;
};
