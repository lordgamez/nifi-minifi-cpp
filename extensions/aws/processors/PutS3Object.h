...
class PutS3Object : public S3Processor {
 public:
  ...
  EXTENSIONAPI static constexpr auto ChecksumAlgorithm = core::PropertyDefinitionBuilder<CHECKSUM_ALGORITHMS.size()>::createProperty("Checksum Algorithm")
      .withDescription("Checksum algorithm used to verify the uploaded object. If not set, CRC64NVME algorithm is used.")
 ...
 protected:
  ...
  Aws::S3::Model::ChecksumAlgorithm checksum_algorithm_{Aws::S3::Model::ChecksumAlgorithm::NOT_SET};
};
