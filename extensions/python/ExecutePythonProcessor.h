...
class ExecutePythonProcessor : public core::ProcessorImpl {
 public:
  ...
  EXTENSIONAPI static constexpr const char* Description = "This processor is only used internally for running NiFi and MiNiFi C++ style python processors. Do not use this processor in your own flows. "
      "Move your python processors to the minifi-python directory where they will be parsed and then they can be used with filename as processor classes.";
