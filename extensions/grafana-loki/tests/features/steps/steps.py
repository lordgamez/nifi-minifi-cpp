...
def step_impl(context, lines: str, timeout_seconds: int):
    assert context.containers["grafana-loki-server"].are_lines_present(lines, timeout_seconds, False)
...
def step_impl(context, lines: str, timeout_seconds: int, tenant_id: str):
    assert context.containers["grafana-loki-server"].are_lines_present(lines, timeout_seconds, False, tenant_id)
...
def step_impl(context, lines: str, timeout_seconds: int):
    assert context.containers["grafana-loki-server"].are_lines_present(lines, timeout_seconds, True)
