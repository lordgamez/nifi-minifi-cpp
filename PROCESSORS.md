...
| Proxy Host                       |               |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Proxy host name or IP. Use https:// prefix for HTTPS proxy. DEPRECATED, please use Proxy Configuration Service instead.<br/>**Supports Expression Language: true**                                                                                                                                          |
| Proxy Port                       |               |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | The port number of the proxy host. DEPRECATED, please use Proxy Configuration Service instead.<br/>**Supports Expression Language: true**                                                                                                                                                                   |
| Proxy Username                   |               |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Username to set when authenticating against proxy. DEPRECATED, please use Proxy Configuration Service instead.<br/>**Supports Expression Language: true**                                                                                                                                                   |
| Proxy Password                   |               |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Password to set when authenticating against proxy. DEPRECATED, please use Proxy Configuration Service instead.<br/>**Sensitive Property: true**<br/>**Supports Expression Language: true**                                                                                                                  |
