...
| **Lazy mode**                   | Off           | On<br/>Off              | Only creates flowfiles from nodes with new timestamp from the server.                                                                                                                          |
...
LlamaCpp processor to use llama.cpp library for LLM inference
...
| Name                             | Default Value                                                                                                                                                                                           | Allowable Values | Description                                                                                                            |
|----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------|------------------------------------------------------------------------------------------------------------------------|
| **Model Path**                   |                                                                                                                                                                                                         |                  | The filesystem path of the model                                                                                       |
| Temperature                      | 0.8                                                                                                                                                                                                     |                  | The inference temperature                                                                                              |
| Top K                            | 40                                                                                                                                                                                                      |                  | Limit the next token selection to the K most probable tokens. <= 0 to use vocab size                                   |
...
| **Text Context Size**            | 512                                                                                                                                                                                                     |                  | Size of the text context, use 0 to use size set in model                                                               |
| **Logical Maximum Batch Size**   | 2048                                                                                                                                                                                                    |                  | Logical maximum batch size that can be submitted to llama_decode                                                       |
| **Physical Maximum Batch Size**  | 512                                                                                                                                                                                                     |                  | Physical maximum batch size                                                                                            |
| **Max Number Of Sequences**      | 1                                                                                                                                                                                                       |                  | Max number of sequences (i.e. distinct states for recurrent models)                                                    |
...
| **Prompt**                       |                                                                                                                                                                                                         |                  | The prompt for the inference<br/>**Supports Expression Language: true**                                                |
| **System Prompt**                | You are a helpful assisstant. You are given a question with some possible input data otherwise called flowfile data. You are expected to generate a response based on the quiestion and the input data. |                  | The system prompt for the inference                                                                                    |
