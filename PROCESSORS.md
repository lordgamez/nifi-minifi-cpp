...
| Temporary Directory Multipart State    |                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Directory in which, for multipart uploads, the processor will locally save the state tracking the upload ID and parts uploaded which must both be provided to complete the upload. If left empty, a temporary directory will be created.                                                                    |
