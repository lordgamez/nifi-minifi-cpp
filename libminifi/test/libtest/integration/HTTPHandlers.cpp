...
void StoppingHeartbeatHandler::sendStartStopOperation(struct mg_connection *conn) {
  ...
  if (post_count_ == 0) {
    requested_operation = "{ \"operationid\" : 41, \"operation\" : \"stop\", \"operand\" : \"2438e3c8-015a-1000-79ca-83af40ec1991\"  }";
  } else if (post_count_ == 1) {
    requested_operation = "{ \"operationid\" : 42, \"operation\" : \"stop\", \"operand\" : \"FlowController\"  }";
  } else if (post_count_ == 2) {
    requested_operation = "{ \"operationid\" : 43, \"operation\" : \"start\", \"operand\" : \"2438e3c8-015a-1000-79ca-83af40ec1991\"  }";
  } else if (post_count_ == 3) {
    requested_operation = "{ \"operationid\" : 44, \"operation\" : \"start\", \"operand\" : \"FlowController\"  }";
  } else if (post_count_ == 4) {
    requested_operation = "{ \"identifier\" : 45, \"operation\" : \"STOP\", \"operand\" : \"PROCESSOR\", \"args\" : { \"processorId\" : \"2438e3c8-015a-1000-79ca-83af40ec1992\" } }";
  } else if (post_count_ == 5) {
    requested_operation = "{ \"identifier\" : 46, \"operation\" : \"STOP\", \"operand\" : \"FLOW\" }";
  } else if (post_count_ == 6) {
    requested_operation = "{ \"identifier\" : 47, \"operation\" : \"START\", \"operand\" : \"PROCESSOR\", \"args\" : { \"processorId\" : \"2438e3c8-015a-1000-79ca-83af40ec1992\" } }";
  } else if (post_count_ == 7) {
    requested_operation = "{ \"identifier\" : 48, \"operation\" : \"START\", \"operand\" : \"FLOW\" }";
  }

  std::string resp = "{\"operation\" : \"heartbeat\", \"requested_operations\" : [ " + requested_operation + " ]}";
  mg_printf(conn, "HTTP/1.1 200 OK\r\nContent-Type: "
            "text/plain\r\nContent-Length: %lu\r\nConnection: close\r\n\r\n",
            resp.length());
