...
SerializedResponseNode DeviceInfoNode::serializeVCoreInfo() const {
...
SerializedResponseNode DeviceInfoNode::serializeOperatingSystemType() const {
...
SerializedResponseNode DeviceInfoNode::serializeTotalPhysicalMemoryInformation() const {
...
SerializedResponseNode DeviceInfoNode::serializePhysicalMemoryUsageInformation() const {
...
SerializedResponseNode DeviceInfoNode::serializeSystemCPUUsageInformation() const {
  double system_cpu_usage = -1.0;
  {
    std::lock_guard<std::mutex> guard(cpu_load_tracker_mutex_);
    system_cpu_usage = cpu_load_tracker_.getCpuUsageAndRestartCollection();
...
SerializedResponseNode DeviceInfoNode::serializeArchitectureInformation() const {
...
SerializedResponseNode DeviceInfoNode::serializeSystemInfo() const {
