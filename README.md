...
| Azure | [AzureStorageCredentialsService](CONTROLLERS.md#azureStorageCredentialsService)<br/>[PutAzureBlobStorage](PROCESSORS.md#putAzureBlobStorage) | -DENABLE_AZURE=ON  |
