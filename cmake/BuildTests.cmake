...
target_compile_options(${TEST_BASE_LIB} PRIVATE ${ADDITIONAL_MINIFI_CPP_COMPILE_OPTIONS})
target_compile_definitions(${TEST_BASE_LIB} PRIVATE ${ADDITIONAL_MINIFI_CPP_COMPILE_DEFINITIONS})
...
FOREACH(testfile ${UNIT_TESTS})
    ...
    target_compile_options("${testfilename}" PRIVATE ${ADDITIONAL_MINIFI_CPP_COMPILE_OPTIONS})
    target_compile_definitions("${testfilename}" PRIVATE ${ADDITIONAL_MINIFI_CPP_COMPILE_DEFINITIONS})
