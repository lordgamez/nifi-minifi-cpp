...
# Recipe based on https://github.com/conan-io/conan-center-index/blob/master/recipes/grpc/all/conanfile.py with added patch
...
class GrpcConan(ConanFile):
    ...
    def requirements(self):
        ...
        if grpc_version > "1.69.0":
            ...
            self.requires("abseil/20260526.0", force=True, transitive_headers=True, transitive_libs=True)
