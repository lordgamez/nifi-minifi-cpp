...
class BustacheConan(ConanFile):
    ...
    def requirements(self):
        # bustache exposes fmt in its public headers (BUSTACHE_USE_FMT)
    ...
    def package(self):
        # Bustache ships no dedicated license file; the BSL-1.0 notice is in the README.
        copy(self, "README.md", src=self.source_folder, dst=os.path.join(self.package_folder, "licenses"))
        # The remove_installs patch strips upstream install rules, so package the artifacts explicitly.
