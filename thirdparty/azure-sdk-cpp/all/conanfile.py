...
# Recipe based on https://github.com/conan-io/conan-center-index/blob/master/recipes/azure-sdk-for-cpp/all/conanfile.py
...
class AzureSDKForCppConan(ConanFile):
    ...
    def requirements(self):
        ...
        if self.settings.os == "Windows":
            ...
            self.requires("wil/1.0.260126.7")
