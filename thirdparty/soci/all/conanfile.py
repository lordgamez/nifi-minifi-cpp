...
#
# Adapted from the conan-center-index soci recipe (BSL-1.0 recipe license),
# updated for SOCI 4.1.4 and pointed at the project's iODBC package instead of
# the unixODBC-based odbc package.
