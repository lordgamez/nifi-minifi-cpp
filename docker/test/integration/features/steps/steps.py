...
from minifi.controllers.SparkplugReader import SparkplugReader
...
@given("a SparkplugReader controller service is set up")
def step_impl(context):
    json_record_set_reader = SparkplugReader("SparkplugReader")
    container = context.test.acquire_container(context=context, name="minifi-cpp-flow")
    container.add_controller(json_record_set_reader)
