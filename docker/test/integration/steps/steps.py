...
def step_impl(context, producer_name, consumer_name):
    ...
    minifi_cert, minifi_key = make_cert("minifi-cpp-flow", root_ca_cert, root_ca_key, b"clientAuth")
    secondary_cert, secondary_key = make_cert("secondary", root_ca_cert, root_ca_key, b"serverAuth")
...
def step_impl(context):
    root_ca_cert, root_ca_key = make_ca("root CA")
    minifi_cert, minifi_key = make_cert("minifi-cpp-flow", root_ca_cert, root_ca_key, b"clientAuth")
    splunk_cert, splunk_key = make_cert("splunk", root_ca_cert, root_ca_key, b"serverAuth")
