...
BEHAVE_OPTS=(--show-progress-bar --logging-level DEBUG --parallel-processes "${_arg_parallel_processes}" --parallel-scheme feature -o "${PWD}/behavex_output_2" -t "${_arg_tags_to_run}")
